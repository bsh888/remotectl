...
const zh: Dict = {
  ...
  feat_quality_title: '画质完全可控',
  feat_quality_desc: '码率、分辨率缩放、帧率三项独立调节，带宽充裕时拉满，移动网络时省流',
  feat_keyboard_title: '移动端全键盘',
  feat_keyboard_desc: '修饰键（Ctrl/Shift/Alt/Win/⌘）单独可用，数字行、方向键、F1–F12 触手可及，参考 Terminus 交互设计',
  // comparison
  vs_title: '对比商业远控',
  vs_subtitle: '与向日葵同属 WebRTC 技术栈，但在以下维度有所不同',
  vs_feat: '特性',
  vs_remotectl: 'RemoteCtl',
  vs_sunflower: '向日葵',
  vs_open_source: '开源',
  vs_self_host: '自托管服务器',
  vs_browser_ctrl: '浏览器直接控制',
  vs_quality_tune: '码率 / 分辨率自定义',
  vs_mobile_kb: '移动端完整键盘',
  vs_session_chat: '会话内聊天 + 传文件',
  vs_free: '完全免费',
  vs_yes: '✓',
  vs_no: '—',
  vs_partial: '部分',
  vs_note: '向日葵数据来自公开资料，如有出入以官方最新版本为准',
  // download
  dl_title: '下载客户端',
  ...
  keyboard: '⌨️',
  disconnect: '断开',
  disconnect_confirm: '确定要断开与远程设备的连接吗？',
...
const en: Dict = {
  ...
  feat_quality_title: 'Tunable Quality',
  feat_quality_desc: 'Bitrate, resolution scale and FPS are independently adjustable — crank it up on fast networks, save bandwidth on mobile',
  feat_keyboard_title: 'Full Mobile Keyboard',
  feat_keyboard_desc: 'Modifier keys (Ctrl/Shift/Alt/Win/⌘) work standalone; number row, arrow keys and F1–F12 always accessible, inspired by Terminus',
  // comparison
  vs_title: 'vs. Commercial Tools',
  vs_subtitle: 'Same WebRTC foundation as Sunflower Remote, different priorities',
  vs_feat: 'Feature',
  vs_remotectl: 'RemoteCtl',
  vs_sunflower: 'Sunflower',
  vs_open_source: 'Open Source',
  vs_self_host: 'Self-hosted Server',
  vs_browser_ctrl: 'Browser Control (no install)',
  vs_quality_tune: 'Custom Bitrate / Resolution',
  vs_mobile_kb: 'Full Mobile Keyboard',
  vs_session_chat: 'In-session Chat + File Transfer',
  vs_free: 'Completely Free',
  vs_yes: '✓',
  vs_no: '—',
  vs_partial: 'partial',
  vs_note: 'Sunflower data based on public information; refer to their official site for latest features',
  dl_title: 'Download',
  ...
  disconnect_confirm: 'Disconnect from the remote device?',
  ...
  delete_record_msg: 'Delete this connection record?',
...
const zh_TW: Dict = {
  ...
  feat_quality_title: '畫質完全可控',
  feat_quality_desc: '碼率、解析度縮放、幀率三項獨立調節，頻寬充裕時拉滿，行動網路時省流',
  feat_keyboard_title: '行動端全鍵盤',
  feat_keyboard_desc: '修飾鍵（Ctrl/Shift/Alt/Win/⌘）可單獨使用，數字列、方向鍵、F1–F12 觸手可及，參考 Terminus 互動設計',
  // comparison
  vs_title: '對比商業遠控',
  vs_subtitle: '與向日葵同屬 WebRTC 技術棧，但在以下維度有所不同',
  vs_feat: '特性',
  vs_remotectl: 'RemoteCtl',
  vs_sunflower: '向日葵',
  vs_open_source: '開源',
  vs_self_host: '自託管伺服器',
  vs_browser_ctrl: '瀏覽器直接控制',
  vs_quality_tune: '碼率 / 解析度自訂',
  vs_mobile_kb: '行動端完整鍵盤',
  vs_session_chat: '會話內聊天 + 傳檔案',
  vs_free: '完全免費',
  vs_yes: '✓',
  vs_no: '—',
  vs_partial: '部分',
  vs_note: '向日葵資料來自公開資料，如有出入以官方最新版本為準',
  dl_title: '下載客戶端',
  ...
  keyboard: '⌨️',
  disconnect: '中斷',
  disconnect_confirm: '確定要中斷與遠端裝置的連線嗎？',
  ...
  edit: '修改',
  delete: '刪除',
  delete_record_title: '刪除記錄',
  delete_record_msg: '確認刪除此連線記錄？',
