...
const REPO          = 'bsh888/remotectl'
const GITHUB_URL    = `https://github.com/${REPO}`
const RELEASES_BASE = `${GITHUB_URL}/releases/download`
const RELEASES_PAGE = `${GITHUB_URL}/releases`
    ...
    <div style={{ fontFamily: V.sans, color: V.text1, minHeight: '100vh', background: V.bg }}>
          ...
          {!isMobile && (
            <div style={{display:'flex', alignItems:'center', gap:4}}>
              ...
              <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" style={{
                ...
                color:V.text2, textDecoration:'none', fontSize:13,
                padding:'5px 12px', borderRadius:3, border:`1px solid ${V.border2}`,
              ...
              >
                ...
                {stars !== null ? `★ ${stars >= 1000 ? (stars/1000).toFixed(1)+'k' : stars}` : 'GitHub'}
              </a>
      ...
      <footer style={{
        ...
        <div style={{display:'flex', alignItems:'center', gap:16}}>
          <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" style={{
            display:'flex', alignItems:'center', gap:5,
            fontFamily:V.mono, fontSize:11, color:V.text3, textDecoration:'none',
